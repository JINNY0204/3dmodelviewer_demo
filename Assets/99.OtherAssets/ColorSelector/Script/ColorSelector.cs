...
public class ColorSelector : MonoBehaviour
{
    ...
    private void Update()
    {
		if (Input.GetMouseButton(0))
			UserMouseInputUpdate();

	}

    public void UserMouseInputUpdate()
    {
	...
	void SelectOuterColor(Vector2 delta)
    {
        ...
        //receiver.SendMessage(methodName, finalColor, SendMessageOptions.DontRequireReceiver);
    }
